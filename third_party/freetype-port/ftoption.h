/*
 * third_party/freetype-port/ftoption.h — FreeType's build options, for a
 * machine with no operating system under it.
 *
 * A copy of the stock ftoption.h with the changes below and nothing
 * else, so a diff against upstream shows exactly what this port decided.
 * Selected with -DFT_CONFIG_OPTIONS_H rather than by editing the tree,
 * which is FreeType's own documented mechanism and what keeps
 * third_party/freetype/ a clean copy of the release.
 *
 * What changed, and why each:
 *
 *   USE_ZLIB, USE_BZIP2, USE_PNG, USE_BROTLI
 *       off. Each needs a library this system does not have. zlib and
 *       brotli are for compressed WOFF, bzip2 for compressed PCF, PNG
 *       for colour bitmap faces — none of which is a TrueType outline.
 *
 *   USE_HARFBUZZ
 *       off. FreeType's optional HarfBuzz use is for the autofitter,
 *       which is not one of the four modules built here.
 *
 *   MAC_FONTS
 *       off. Resource-fork fonts need Carbon.
 *
 *   INCREMENTAL, SVG
 *       off. Both are hooks for a host application that supplies glyphs
 *       or rasterises SVG, and there is none.
 *
 * TT_CONFIG_OPTION_BYTECODE_INTERPRETER is left *on*, deliberately. It
 * is what makes small text legible and the main reason to prefer
 * FreeType's metrics to a naive table parse.
 *
...
#define FT_CONFIG_OPTION_USE_LZW
   ...
   */
/* vextro: off */  /* #define FT_CONFIG_OPTION_USE_ZLIB */
...
#define FT_CONFIG_OPTION_ADOBE_GLYPH_LIST
   ...
   */
/* vextro: off */  /* #define FT_CONFIG_OPTION_MAC_FONTS */
...
#define FT_CONFIG_OPTION_GUESSING_EMBEDDED_RFORK
   ...
   */
/* vextro: off */  /* #define FT_CONFIG_OPTION_INCREMENTAL */
...
#undef FT_CONFIG_OPTION_USE_MODULE_ERRORS
   ...
   */
/* vextro: off */  /* #define FT_CONFIG_OPTION_SVG */
